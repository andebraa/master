...
axs[0].plot(actual_dnn[:,0], actual_dnn[:,1], 'o', label = 'real data')
axs[0].plot(random_dnn[:,0], random_dnn[:,1], 'o', label = 'random data')
axs[1].plot(actual_cnn[:,0], actual_cnn[:,1], 'o', label = 'real data')
axs[1].plot(random_cnn[:,0], random_cnn[:,1], 'o', label = 'random data')
axs[0].legend()
axs[1].legend()
