...
def get_load_curves():
    ...
    for vel, seed in varyspeed.items():
        ...
        if isinstance(seed, tuple):
            for see in seed:
                logfiles = f'../../simulations/sys_asp{asperities}_uc{uc}/vary_strange/sim_temp{temp}_force{force}_asp{asperities}_or{orientation}_time{time}_seed{see}_errgrid4_4/log.lammps'
                print(logfiles)
                if logfiles == []:
                ...
                for logfile in glob(logfiles):
                    ...
                    outfile_lc = f'../../txt/load_curves/erratic/vary_strange/load_curves_temp{temp}_vel{vel}_force{force}_asp{asperities}_or{orientation}_seed{see}_errgrid4_4.txt'
                    outfile_ms = f'../../txt/max_static/erratic/vary_strange/max_static_temp{temp}_vel{vel}_force{force}_asp{asperities}_or{orientation}_seed{see}_errgrid4_4.txt'
                    outfile_rise = f'../../txt/rise/erratic/vary_strange/rise_temp{temp}_vel{vel}_force{force}_asp{asperities}_or{orientation}_seed{see}_errgrid4_4.txt'
...
def all_curves(production = True):
    ...
    if production: #beware /datset here
        ...
        filetemplate = f'../../simulations/sys_asp{asperities}_uc{uc}/vary_strange/sim_temp{temp}_force*_asp{asperities}_or{orientation}_time{time}_seed*_errgrid4_4/log.lammps'
    ...
    for _file in files:
        if production: 
            ...
            outfile_lc= '../../txt/load_curves/erratic/vary_strange/load_curves_temp{}_vel{}_force{}_asp{}_or{}_seed{}_errgrid4_4.txt'
            outfile_ms = '../../txt/max_static/erratic/vary_strange/max_static_temp{}_vel{}_force{}_asp{}_or{}_seed{}_errgrid4_4.txt'
            outfile_rise = '../../txt/rise/erratic/vary_strange/rise_temp{}_vel{}_force{}_asp{}_or{}_seed{}_errgrid4_4.txt'
